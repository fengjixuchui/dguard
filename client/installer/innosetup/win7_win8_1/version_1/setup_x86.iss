...
#define MyAppPublisher "Burlutsky St."
...
UninstallDisplayName=Uninstall Data Guard
...
Source: "D:\super_product\super_product\client\installer\innosetup\win7_win8_1\version_1\ui\dgui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\super_product\super_product\client\installer\innosetup\win7_win8_1\version_1\x86\DgiService.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "x86\dgiflock.cat"; DestDir: "{app}"; Flags: ignoreversion
Source: "x86\dgiFLock.inf"; DestDir: "{app}"; Flags: ignoreversion
Source: "x86\dgiFLock.sys"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: {sys}\TASKKILL.exe; Parameters: "/F /IM dgiservice.exe" ; Flags: runhidden 32bit
; http://www.regedit.su/silent-install-application/77-v/830-silent-install-vcredist
...
Filename: {sys}\rundll32.exe; Parameters: "setupapi,InstallHinfSection DefaultInstall 128 {app}\dgiFLock.inf"; WorkingDir: {app}; Flags: 32bit;
;Filename: {sys}\rundll32.exe; Parameters: "setupapi,InstallHinfSection DefaultInstall 128 {app}\dgiFErase.inf"; WorkingDir: {app}; Flags: 32bit;
...
[UninstallRun]
Filename: {sys}\TASKKILL.exe; Parameters: "/F /IM gdui.exe" ; Flags: runhidden 32bit
;Filename: {sys}\sc.exe; Parameters: "stop dgiflock" ; Flags: runhidden 32bit
;Filename: {sys}\sc.exe; Parameters: "stop dgiferase" ; Flags: runhidden 32bit
Filename: {sys}\sc.exe; Parameters: "delete dgiflock" ; Flags: runhidden 32bit
;Filename: {sys}\sc.exe; Parameters: "delete dgiferase" ; Flags: runhidden 32bit
Filename: {sys}\sc.exe; Parameters: "stop DgiService" ; Flags: runhidden 32bit
Filename: {sys}\sc.exe; Parameters: "delete DgiService" ; Flags: runhidden 32bit
...
begin
  ...
  if IsWin64 then
  begin                     
    SuppressibleMsgBox('Error:The Windows version is 64 bit. Please download distributive for x64 CPU.', mbError, MB_OK, MB_OK);
    Result := False;
  end;
end;
