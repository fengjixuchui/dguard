...
class DgiBankingHandler : virtual public DgiBankingIf {
 public:
  DgiBankingHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<DgiBankingHandler> handler(new DgiBankingHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new DgiBankingProcessor(handler));
